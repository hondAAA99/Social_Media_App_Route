...
import { signUpSchema, signInSchema, confirmSignUpSchema, forgetPassword, resetPassowrd, confirmLoginSchema, EnableTwoStepVerfiction, } from './auth.validationSchema.js';
...
authRouter.get('/enable-two-step-verfiction', validationMiddleWare(EnableTwoStepVerfiction), auth.EnableTwoStepVerfiction);
