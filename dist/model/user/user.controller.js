...
userRouter.put("/forget-password", validationMiddleWare(forgetPassword), userServices.forgetPassword);
userRouter.patch("/reset-password", validationMiddleWare(resetPassowrd), userServices.resetPassowrd);
