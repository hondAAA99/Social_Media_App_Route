...
userRouter.post('/create-signed-url', validationMiddleWare(createSignedUrlSchem), authenticate, userServices.uploadBySignedUrl);
userRouter.post('/get-file/*path', userServices.getFile);
userRouter.post('/get-signed-url/*path', userServices.getSignedUrl);
